...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/editormode/PycharmProjects/02 Hands-on Activity 2 - ARG/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/editormode/PycharmProjects/02 Hands-on Activity 2 - ARG/venv/bin/deactivate.nu'
